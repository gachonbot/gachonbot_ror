...
class BasicController < ApplicationController
    ...
    def chat_control
        ...
        if @response == "시작하기"
          ...
          resp = HTTParty.get("http://sandbox.api.simsimi.com/request.p?key=e7501386-fca8-4723-b278-36755e917526&lc=ko&ft=1.0&text=#{@response.encode("UTF-8", invalid: :replace, undef: :replace)}")
            @msg = {
              message: {
                  text: resp.body
              },
